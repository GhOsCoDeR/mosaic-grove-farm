    ...
    <div className="min-h-screen flex flex-col">
      ...
      <div className="flex-grow flex items-center justify-center bg-mosaic-earth-light py-16 px-4">
        <div className="text-center max-w-md">
          ...
          <Link to="/" className="inline-flex items-center justify-center px-5 py-2 border border-transparent text-base font-medium rounded-md text-white bg-mosaic-green hover:bg-mosaic-green-dark">
            Return to Home
          </Link>
        </div>
      </div>
